...
- **CFG_BUILD_KERNEL_STACK**
  ...
  Determines which kernel interface library of the stack to link with the daemon application.
  ...
  - __PCP Daemon Dual-Proc shm__
    ...
    communicating to the daemon through shared memory (dual processor).
