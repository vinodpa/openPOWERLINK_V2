...
set afi_wr_clk  mnSocHostifGpio:soc_inst|mnSocHostifGpio_host_0:host_0|mnSocHostifGpio_host_0_hps_0:hps_0|mnSocHostifGpio_host_0_hps_0_hps_io:hps_io|mnSocHostifGpio_host_0_hps_0_hps_io_border:border|hps_sdram:hps_sdram_inst|hps_sdram_pll:pll|afi_clk_write_clk
set wr_clk      mnSocHostifGpio:soc_inst|mnSocHostifGpio_host_0:host_0|mnSocHostifGpio_host_0_hps_0:hps_0|mnSocHostifGpio_host_0_hps_0_hps_io:hps_io|mnSocHostifGpio_host_0_hps_0_hps_io_border:border|hps_sdram:hps_sdram_inst|hps_sdram_pll:pll|pll_write_clk_dq_write_clk
